...
#define GLFW_PLATFORM_WINDOW_STATE GLFW_COCOA_WINDOW_STATE 

#define GLFW_PLATFORM_MONITOR_STATE GLFW_COCOA_MONITOR_STATE 

#define GLFW_PLATFORM_CURSOR_STATE GLFW_COCOA_CURSOR_STATE

#define GLFW_PLATFORM_JOYSTICK_STATE

#define GLFW_PLATFORM_LIBRARY_WINDOW_STATE GLFW_COCOA_LIBRARY_WINDOW_STATE

#define GLFW_PLATFORM_LIBRARY_JOYSTICK_STATE GLFW_COCOA_LIBRARY_JOYSTICK_STATE

#define GLFW_PLATFORM_CONTEXT_STATE GLFW_NSGL_CONTEXT_STATE

#define GLFW_PLATFORM_LIBRARY_CONTEXT_STATE GLFW_NSGL_LIBRARY_CONTEXT_STATE
